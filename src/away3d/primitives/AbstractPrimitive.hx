package away3d.primitives;
    ...
    */ 
    class AbstractPrimitive extends Mesh {
		...
		arcane var _uv:UV;
		/** @private */
		arcane var _uvStore:Array<Dynamic> ;
		/** @private */
        arcane var _uvActive:Array<Dynamic> ;
		/** @private */
		arcane var _face:Face;
		/** @private */
		arcane var _faceStore:Array<Dynamic> ;
		/** @private */
        arcane var _faceActive:Array<Dynamic> ;
		/** @private */
		...
		/** @private */
		arcane function createUV(?u:Int = 0, ?v:Int = 0):UV
		{
			if (_uvStore.length) {
