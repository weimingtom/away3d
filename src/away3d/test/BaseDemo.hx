...
class BaseDemo extends Sprite  {
	...
	public function new(title:String, ?infogroupheight:Float=410) {
		...
		statsgroup.addChild(new Panel());
		fpslabel = new TextField();
		fpslabel.x = 10;
		fpslabel.y = 10;
		fpslabel.defaultTextFormat = new TextFormat();
		fpslabel.text = "";
		...
		trilabel.defaultTextFormat = new TextFormat();
		trilabel.text = "";
		trilabel.height = 22;
		trilabel.width = 380;
		...
		copylabel.defaultTextFormat = new TextFormat();
		...
		titlegroup.addChild(new Panel());
		titlelabel = new TextField();
		titlelabel.autoSize = TextFieldAutoSize.CENTER;
		titlelabel.x = 180;
		titlelabel.y = 10;
		titlelabel.defaultTextFormat = new TextFormat();
		...
		centergroup.addChild(new Panel());
		startlabel = new TextField();
		startlabel.autoSize = TextFieldAutoSize.CENTER;
		startlabel.x = 0;
		startlabel.y = -18;
		startlabel.defaultTextFormat = new TextFormat();
