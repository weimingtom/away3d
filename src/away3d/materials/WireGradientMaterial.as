    ...
    */
    public class WireGradientMaterial extends EventDispatcher implements ITriangleMaterial, IShapeMaterial
    {
        ...
        */
        ...
        private var _boxMatrix:Matrix;
        private var _gradientObj:Object;
        ...
        public function WireGradientMaterial(color1:* = null, color2:* = null, init:Object = null)
        {
            ...
            gradientType = ini.getString("gradientType", GradientType.RADIAL);
            ...
            boxWidth = ini.getNumber("boxWidth", 1500, {min:0});
	        boxHeight = ini.getNumber("boxHeight", 500, {min:0});
	        boxRotation = ini.getNumber("boxRotation", 0);
	        boxTx = ini.getNumber("boxTx", -750);
	        boxTy = ini.getNumber("boxTy", -400);
        ...
        public function calculateGradient():void
        {
        	_boxMatrix = new Matrix();
        	_boxMatrix.createGradientBox(boxWidth, boxHeight, boxRotation, boxTx, boxTy);
        	_gradientObj = {gradientType:gradientType, colors:[color1, color2], alphas:[alpha1, alpha2], ratios:[ratio1, ratio2], mat:_boxMatrix, spreadMethod:spreadMethod, interpolationMethod:interpolationMethod};
        }
        ...
        public function renderShape(shp:DrawShape):void
        {
			...
			shp.source.session.renderShapeGradient(width, wirecolor, wirealpha, _gradientObj, shp);
        }
