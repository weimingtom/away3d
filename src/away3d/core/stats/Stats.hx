...
class Stats extends Sprite  {
	...
	private var fpstotal:Int;
	private var refreshes:Int;
	private var bestfps:Int;
	...
	private var barscale:Int;
	private var stageframerate:Float;
	...
	public static inline var REVISION:String = "3.0";
	...
	public function new(scope:View3D, ?framerate:Float=0) {
		// autogenerated
		super();
		...
		scopeMenu = scope;
		stageframerate = ((framerate) > 0) ? framerate : 30;
		displayState = 0;
	...
	private function generateSprite():Void {
		...
		bar.y = 22;
		barwidth = 244;
		barscale = Std.int(barwidth / stageframerate);
		// displays Away logo
		displayPicto();
		// Generate textfields
		// title
	...
	public function updateStats(renderedfaces:Int, camera:Camera3D):Void {
		...
		if (displayState == 0) {
			...
			ramLabel.text = "" + Std.int(System.totalMemory / 1024 / 102.4) / 10 + "MB";
