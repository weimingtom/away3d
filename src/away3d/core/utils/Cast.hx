    ...
    class Cast
     {
        ...
        static var colornames:Dictionary;
        inline static var hexchars:String = "0123456789abcdefABCDEF";

        static function hexstring(string:String):Bool
        {
        ...
        public static function trycolor(data:Dynamic):UInt
        {
            if (Std.is( data, uint))
                return cast( data, uint);
        ...
        static var notclasses:Dictionary = new Dictionary();
        static var classes:Dictionary = new Dictionary();
        ...
        public static function tryclass(name:String):Dynamic
        {
            ...
            try
            {
                result = cast( getDefinitionByName(name), Class);
                classes[name] = result;
                return result;
            }
        ...
        public static function material(data:Dynamic):ITriangleMaterial
        {
            if (data == null)
                return null;
            ...
            if (Std.is( data, Object))
            {
                ...
                if (bitmap != null)
                {
                    ...
                    var precision:Int = ini.getNumber("precision", 0);
                    if (precision)
                    {
                        if (lighting)
        ...
        public static function wirematerial(data:Dynamic):ISegmentMaterial
        {
            ...
            if (Std.is( data, String))
            {
                ...
                if ((cast( data, String)).indexOf("#") == 0)
                    data = (cast( data, String)).substring(1);
            ...
            if (Std.is( data, Object))
            {
                ...
                var alpha:Int = dat.getNumber("alpha", 1, {min:0, max:1});
                var width:Int = dat.getNumber("width", 1, {min:0});
