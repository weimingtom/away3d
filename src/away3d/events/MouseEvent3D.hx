package away3d.events;
    ...
    */
    class MouseEvent3D extends Event {
    	 ...
    	 * Defines the value of the type property of a mouseOver3d event object.
    	 */
    	inline public static var MOUSE_OVER:String = "mouseOver3d";
    	
    	/**
    	 * Defines the value of the type property of a mouseOut3d event object.
    	 */
    	inline public static var MOUSE_OUT:String = "mouseOut3d";
    	
    	/**
    	 * Defines the value of the type property of a mouseUp3d event object.
    	 */
    	inline public static var MOUSE_UP:String = "mouseUp3d";
    	
    	/**
    	 * Defines the value of the type property of a mouseDown3d event object.
    	 */
    	inline public static var MOUSE_DOWN:String = "mouseDown3d";
    	
    	/**
    	 * Defines the value of the type property of a mouseMove3d event object.
    	 */
    	inline public static var MOUSE_MOVE:String = "mouseMove3d";
