package loaders
{
	...
	public class ExChangeBitmapMaterial extends BasicTemplate
	{
		...
		override protected function onInit():void
		{
			...
			var url:URLRequest = new URLRequest("../src/basics/assets/earth.jpg");
		...
		private function onLoad3DObject(event:Event):void
		{
			...
			loader = new Loader3D();
			loader.loadGeometry("../src/loaders/assets/dae/Total_Immersion_Anim_Object2_matrix_keys.dae", collada);
