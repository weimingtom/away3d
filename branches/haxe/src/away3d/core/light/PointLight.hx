...
class PointLight extends LightPrimitive  {
	...
	public function setViewPosition(view:View3D):Void {
		...
		if (viewPositions[untyped view] == null) {
			viewPositions[untyped view] = new Number3D();
		}
		viewPositions[untyped view].clone(view.cameraVarsStore.viewTransformDictionary[untyped _light].position);
	}
