package away3d.core.stats; 
    ...
    class Stats extends Sprite {
        public var image(getImage, null) : Array<Dynamic>
        ;
        
        var totalElements:Int ;
        var meshes:Int ;
        public var scopeMenu:View3D ;
        public var displayMenu:Sprite ;
        public var geomMenu:Sprite ;
        var lastrender:Int;
        var fpsLabel:StaticTextField;
        var titleField:StaticTextField;
        var perfLabel:StaticTextField;
        var ramLabel:StaticTextField;
        var swfframerateLabel:StaticTextField;
        var avfpsLabel:StaticTextField;
        var peakLabel:StaticTextField;
        var faceLabel:StaticTextField;
        var faceRenderLabel:StaticTextField;
        var geomDetailsLabel:TextField;
        var meshLabel:StaticTextField;
        var fpstotal:Int ;
        var refreshes:Int ;
        var bestfps:Int ;
        var lowestfps:Int ;
        ...
        var geombtn:Sprite;
        var barscale:Int ;
        var stageframerate:Float;
        var displayState:Int;
        var camLabel:TextField;
        var camMenu:Sprite;
        var camProp:Array<Dynamic>;
        var rectclose:Rectangle ;
        var rectcam:Rectangle ;
        var rectclear:Rectangle ;
        var rectdetails:Rectangle ;
        var geomLastAdded:String;
        var defautTF:TextFormat ;
		var defautTFBold:TextFormat ;
        //
        var VERSION:String ;
        var REVISION:String ;
        ...
        public function new(scope:View3D, ?framerate:Int = 0)
        {
            ...
            defautTF = new TextFormat("Verdana", 10, 0x000000);
            defautTFBold = new TextFormat("Verdana", 10, 0x000000, true);
            VERSION = "2";
            REVISION = "2.0";
            APPLICATION_NAME = "Away3D.com";
            scopeMenu = scope;
        ...
        //Mouse Events
        function addEventMouse():Void
        {  
            scopeMenu.addEventListener(MouseEvent.MOUSE_DOWN, onCheckMouse);
            scopeMenu.addEventListener(MouseEvent.MOUSE_MOVE, updateTips);
        }
        
        function updateTips(me:MouseEvent):Void
        { 
            if(scopeMenu != null){
                var x:Int = displayMenu.mouseX;
                var y:Int = displayMenu.mouseY;
        ...
        function onCheckMouse(me:MouseEvent):Void
        { 
            var x:Int = displayMenu.mouseX;
            var y:Int = displayMenu.mouseY;
            var pt:Point = new Point(x,y);
        ...
        function closeOtherScreen(actual:Int):Void {
             switch(actual){
                case 1:
                hideCamInfo();
                break;
        ...
        function hideGeomInfo():Void
        {   
            if(geomMenu != null){
                displayMenu.removeChild(geomMenu);
            }
        }
        function createGeometryMenu():Void{
            geomMenu = new Sprite();
            var myMatrix:Matrix = new Matrix();
            myMatrix.rotate(90 * Math.PI/180);
        ...
        function getImage():Array<Dynamic>
        {
