package away3d.core.render;
    ...
    */
	class BitmapRenderSession extends AbstractRenderSession {
		...
		var _container:Bitmap;
		var _width:Int;
		var _height:Int;
		var _bitmapwidth:Int;
		var _bitmapheight:Int;
		var _scale:Float;
		var _cm:Matrix;
		var _cx:Float;
		var _cy:Float;
		var _base:BitmapData;
		var mStore:Array<Dynamic> ;
		var mActive:Array<Dynamic> ;
		 ...
		 */
		public function new(?scale:Int = 2)
		{
		...
		{
			_container = cast( getContainer(view), Bitmap);
