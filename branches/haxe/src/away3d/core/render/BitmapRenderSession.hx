...
class BitmapRenderSession extends AbstractRenderSession  {
	...
	private var _bitmapContainers:HashMap<View3D, Bitmap>;
	...
	private var layers:Array<DisplayObject>;
	...
	public function new(?scale:Float=2) {
		// autogenerated
		super();
		this._bitmapContainers = new HashMap<View3D, Bitmap>();
		this.layers = [];
	...
	public override function getContainer(view:View3D):DisplayObject {
		...
		if (!_containers.contains(view)) {
			_container = _containers.put(view, new Sprite());
	...
	public function getBitmapContainer(view:View3D):Bitmap {
		...
		if (!_bitmapContainers.contains(view)) {
			return _bitmapContainers.put(view, new Bitmap());
		}
		return _bitmapContainers.get(view);
	}
