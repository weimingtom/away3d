package away3d.core.project;
	...
	class MovieClipSpriteProjector extends AbstractProjector, implements IPrimitiveProvider {
		
		var _movieClipSprite:MovieClipSprite;
		var _movieclip:DisplayObject;
		var _child:Object3D;
