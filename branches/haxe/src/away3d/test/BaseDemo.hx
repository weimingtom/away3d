package away3d.test;
    ...
    */ 
    class BaseDemo extends Sprite {
        ...
        var centergroup:Sprite;
        var startlabel:TextField;

        var titlegroup:Sprite;
        var statsgroup:Sprite;
        var infogroup:Sprite;
        var lefttopgroup:Sprite;

        var copylabel:TextField;
        var fpslabel:TextField;
        var cpulabel:TextField;
        var trilabel:TextField;
        var messagelabel:TextField;
        ...
        public function new(title:String, ?infogroupheight:Int = 410)
        {
        ...
        function addSlide(title:String, text:String, scene:Scene3D, renderer:IRenderer, session:AbstractRenderSession):Void
        {
        ...
        function setScroll(value:Bool):Void
        {
            scroll = value;
            if (!scroll)
            {
        ...
        function adjustzoom(delta:Int):Void
        {
