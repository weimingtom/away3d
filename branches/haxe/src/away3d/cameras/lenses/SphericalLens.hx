...
class SphericalLens extends AbstractLens, implements ILens {
	
	private var _wx:Float;
	private var _wy:Float;
	private var _wz:Float;
	private var _wx2:Float;
	private var _wy2:Float;
	private var _c:Float;
	private var _c2:Float;
	...
	public function project(viewTransform:Matrix3D, vertex:Vertex):ScreenVertex {
		...
		_persp = (_c2 > 0) ? _camera.zoom * _camera.focus * (_c - _wz) / _c2 : 0;
