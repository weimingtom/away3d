package away3d.loaders;
    ...
    */
    class Ase extends AbstractParser {
        ...
        function parseAse(data:String):Void
        {
                ...
                switch (chunk)
                {
                    case 'MESH_VERTEX_LIST':
                        while (true)
                        {
                            ...
                            // Swapped Y and Z
                            var x:Int = parseFloat(mvl[1]) * scaling;
                            var z:Int = parseFloat(mvl[2]) * scaling; 
                            var y:Int = parseFloat(mvl[3]) * scaling;
                    ...
                    case 'MESH_FACE_LIST':
                        while (true)
                        {
                            ...
                            var drc:Array<Dynamic> = mfl.split( ':' ); // separate here
		 ...
		 */
        public static function parse(data:Dynamic, ?init:Dynamic = null, ?loader:Object3DLoader = null):Mesh
        {
