package away3dlite.primitives
{
    ...
    */ 
    public class SeaTurtle extends Mesh
    {
        ...
        {
            _indicies.push(_vertices.length, _vertices.length + 1, _vertices.length + 2);
        	_vertices.push(varr[vn0],varr[vn1],varr[vn2]);
        	_uvData.push(uvarr[uvn0],uvarr[uvn1],uvarr[uvn2]);
        	_faceLengths.push(3);
        }
