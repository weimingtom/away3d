...
package jiglib.physics
{
	...
	public class RigidBody
	{
	    ...
	    public function RigidBody(skin:*, mov:Boolean = true)
	    {
			_id = idCounter++;
		...
		public function updateObject3D():void
	    {
			...
			_skin.transform=JMatrix3D.multiply(JMatrix3D.translationMatrix(p.x, p.y, p.z), o).toAway3D();
	    }
	}
}