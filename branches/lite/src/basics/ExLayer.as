package basics
{
	...
	public class ExLayer extends BasicTemplate
	{
		...
		override protected function onInit():void
		{
			...
			{
				// Plane
				plane = new Plane(new BitmapFileMaterial("../src/basics/assets/earth.jpg"), 256, 128, 1, 1);
			...
			// no layer test
			var earth:Sphere = new Sphere(new BitmapFileMaterial("../src/basics/assets/earth.jpg"), 100, 10, 10);
			scene.addChild(earth);

			// on top layer
			var moon:Sphere = new Sphere(new BitmapFileMaterial("../src/basics/assets/earth.jpg"), 25, 10, 10);
			scene.addChild(moon);
