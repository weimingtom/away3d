package
{
	...
	public class Advanced_NormalmappedMustang extends MovieClip
	{
		...
		//ferrari texture
		[Embed(source="assets/Mustang_diffuse_512.png")]
		...
		//material objects
		private var bodyMaterial:Dot3BitmapMaterialF10;
		...
		{
			bodyMaterial = new Dot3BitmapMaterialF10(Cast.bitmap(BodyTexture), Cast.bitmap(Normalmap), {specular:0.5, shininess:40});
