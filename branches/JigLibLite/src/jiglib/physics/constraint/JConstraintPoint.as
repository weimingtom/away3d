...
package jiglib.physics.constraint
{
	...
	public class JConstraintPoint extends JConstraint
	{
		...
		override public function preApply(dt:Number):void
		{
			...
			r0 = _body0Pos.clone();
			JMatrix3D.getMultiplyVector(_body0.currentState.orientation, r0);
			r1 = _body1Pos.clone();
			JMatrix3D.getMultiplyVector(_body1.currentState.orientation, r1);
		...
		override public function apply(dt:Number):Boolean
		{
			...
			JMatrix3D.getMultiplyVector(_body0.worldInvInertia, tempVec1);
			var tempVec2:Vector3D = r1.crossProduct(N);
			JMatrix3D.getMultiplyVector(_body1.worldInvInertia, tempVec2);
