package away3d.graphs
{
	...
	public class ArrayIterator extends EventDispatcher implements IIterator
	{
		...
		public function next() : Object
		{
			...
			return ++_traverseIndex < _array.length? _array[_traverseIndex] : null;
		}
		...
		private function performMethodStep() : void
		{
			...
			do {
				_asyncMethod(_array[_traverseIndex]);
			} while (++_traverseIndex < _arrayLen && getTimer() - startTime < _maxTimeOut);

			if (_traverseIndex < _arrayLen)
