package away3d.objects
{
    ...
    public class Cube extends Mesh3D
    {
        ...
        public function Cube(material:IMaterial, init:Object = null)
        {
            ...
            //left face
            addFace3D(new Face3D(v000, v010, v001, faceMaterials[0], uvd, uva, uvc));
            addFace3D(new Face3D(v010, v011, v001, faceMaterials[0], uva, uvb, uvc));
            //right face
            addFace3D(new Face3D(v100, v101, v110, faceMaterials[1], uvc, uvd, uvb));
            addFace3D(new Face3D(v110, v101, v111, faceMaterials[1], uvb, uvd, uva));
            //bottom face
            addFace3D(new Face3D(v000, v001, v100, faceMaterials[2], uvb, uvc, uva));
            addFace3D(new Face3D(v001, v101, v100, faceMaterials[2], uvc, uvd, uva));
            //top face
            addFace3D(new Face3D(v010, v110, v011, faceMaterials[3], uvc, uvd, uvb));
            addFace3D(new Face3D(v011, v110, v111, faceMaterials[3], uvb, uvd, uva));
            //front face
            addFace3D(new Face3D(v000, v100, v010, faceMaterials[4], uvc, uvd, uvb));
            addFace3D(new Face3D(v100, v110, v010, faceMaterials[4], uvd, uva, uvb));
            //back face
            addFace3D(new Face3D(v001, v011, v101, faceMaterials[5], uvd, uva, uvc));
            addFace3D(new Face3D(v101, v011, v111, faceMaterials[5], uvc, uva, uvb));
        }
    }
