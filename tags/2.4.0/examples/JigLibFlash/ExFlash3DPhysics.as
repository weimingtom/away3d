package
{
	...
	/**
	 *
	 * JigLibFlash (rev99) for Away3D test run
	 *
	...
	public class ExFlash3DPhysics extends SimpleView
	{
		...
		{
			super("JigLib", "JigLib rev99 via Away3D rev1454, Engine test run by katopz");
		...
		override protected function create():void
		{
			...
			var ground:RigidBody = physics.createGround({width: 1000, height: 1000}, 200);
