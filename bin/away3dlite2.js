...
ExSphereCubeTest = function(p) { if( p === $_ ) return; {
	$s.push("ExSphereCubeTest::new");
	var $spos = $s.length;
...
ExSphereCubeTest.__name__ = ["ExSphereCubeTest"];
ExSphereCubeTest.main = function() {
	$s.push("ExSphereCubeTest::main");
	var $spos = $s.length;
...
ExSphereCubeTest.prototype.currTime = null;
ExSphereCubeTest.prototype.fpsCounter = null;
ExSphereCubeTest.prototype.frameCount = null;
ExSphereCubeTest.prototype.material = null;
ExSphereCubeTest.prototype.onEnterFrame = function(event) {
	$s.push("ExSphereCubeTest::onEnterFrame");
	var $spos = $s.length;
	this.onPreRender();
	this.view.render();
	$s.pop();
}
ExSphereCubeTest.prototype.onInit = function(e) {
	$s.push("ExSphereCubeTest::onInit");
	var $spos = $s.length;
				...
				while(_g1 < amount) {
					var j1 = _g1++;
					{
						...
						while(_g2 < amount) {
							...
							sphere.set_x(gap * i1 - ((amount - 1) * gap) / 2);
							sphere.set_y(gap * j1 - ((amount - 1) * gap) / 2);
							sphere.set_z(gap * k1 - ((amount - 1) * gap) / 2);
						}
					}
				}
			}
...
ExSphereCubeTest.prototype.onMouseDown = function(event) {
	$s.push("ExSphereCubeTest::onMouseDown");
	var $spos = $s.length;
...
ExSphereCubeTest.prototype.onMouseUp = function(event) {
	$s.push("ExSphereCubeTest::onMouseUp");
	var $spos = $s.length;
	var sphere = new away3dlite.primitives.Sphere();
...
ExSphereCubeTest.prototype.onPreRender = function() {
	$s.push("ExSphereCubeTest::onPreRender");
	var $spos = $s.length;
...
ExSphereCubeTest.prototype.persp = null;
ExSphereCubeTest.prototype.stage = null;
ExSphereCubeTest.prototype.textCount = null;
ExSphereCubeTest.prototype.view = null;
ExSphereCubeTest.prototype.__class__ = ExSphereCubeTest;
...
$Main.init = ExSphereCubeTest.main();
